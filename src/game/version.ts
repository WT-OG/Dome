const Sigma = require("express");
const sigma = Sigma.Router();

sigma.get("/fortnite/api/version", async (req, res) => {
    res.json({
        "app": "fortnite",
...
sigma.get("/fortnite/api/v2/versioncheck/*", async (req, res) => {
    res.json({
        "type": "NO_UPDATE"
    })
})
...
sigma.get("/fortnite/api/versioncheck*", async (req, res) => {
    res.json({
        "type": "NO_UPDATE"
    })
})
